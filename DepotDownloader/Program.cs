...
namespace DepotDownloader
{
    ...
    class Program
    {
        ...
        static void PrintUsage()
        {
            ...
            Console.WriteLine("  Add dump key support:    ");
            Console.WriteLine("  When you are obtaining the game or manifest, the decryption key will be automatically extracted to the keys.txt file in the root directory.");
        }
