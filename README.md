...
And I add dump key support: When you are obtaining the game or manifest, the decryption key will be automatically extracted to the "keys.txt" file in the root directory.
