...
And I have also added support for more functions, such as key dumping: When you are obtaining the game or manifest, the decryption key will be automatically extracted to the "keys.txt" file in the root directory. The format is `{depotId};{keyHex}`
